...
Programa destinado a Stanley Oliveira

input: lista de tuplas com campos repetidos ou em excesso
output: conjunto de tuplas que respeita uma frequencia dada
